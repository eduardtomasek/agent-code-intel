...
This project is indexed by GitNexus as **agent-code-intel** (1730 symbols, 3528 relationships, 48 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
