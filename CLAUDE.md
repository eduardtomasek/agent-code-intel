...
This project is indexed by GitNexus as **agent-code-intel** (1824 symbols, 3769 relationships, 52 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
