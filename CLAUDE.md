...
This project is indexed by GitNexus as **agent-code-intel** (1790 symbols, 3678 relationships, 49 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
