...
This project is indexed by GitNexus as **agent-code-intel** (2059 symbols, 4381 relationships, 54 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
