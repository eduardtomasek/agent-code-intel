...
This project is indexed by GitNexus as **agent-code-intel** (1389 symbols, 2922 relationships, 21 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
