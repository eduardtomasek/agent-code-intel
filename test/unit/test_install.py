...
class Run(Base):
    ...
    def test_clean_install_prints_every_line_in_order(self):
        ...
        self.assertEqual(
            ...
            + "installed -> %s (code-intel-dash 1.4.0)\n"
    ...
    def test_clean_install_installs_dashboard_at_its_own_version(self):
        ...
        self.assertEqual(proc.stdout, "code-intel-dash 1.4.0\n")
    ...
    def test_matching_dashboard_version_is_not_rewritten(self):
        ...
        self.assertIn("code-intel-dash 1.4.0 already installed at", out)
    ...
    def test_matching_non_executable_dashboard_is_repaired(self):
        ...
        self.assertIn("installed -> %s (code-intel-dash 1.4.0)" % dashboard, out)
