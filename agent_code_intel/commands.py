...
- **GitNexus** (MCP: `gitnexus_query`, `gitnexus_context`, `gitnexus_impact`,
  ...
  cross-file impact, call-graph-aware renames, and `gitnexus_detect_changes`
...
and a running watcher rewrites that file from memory. Re-run this tool instead.
<!-- code-intel:end -->"""
        ...
        if os.path.isfile(context.grepai_cfg):
            ...
            if updated != text:
                ...
                if integrations.watcher_running(stack.watch_status(context.workspace)):
                    ...
                    stack.watch_start_background(context.workspace)
